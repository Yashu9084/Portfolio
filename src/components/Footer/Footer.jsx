      ...
      <div className="container">
        <div className="sm:flex items-center justify-between md:gap-8">
          <div className="w-full sm:w-1/2">
            <h2 className="text-[26px] leading-0 text-white font-[600] mb-5 md:text-[2rem] ">
          ...
          <div className="w-full sm:w-1/2 ">
            <p className="text-gray-300 leading-7 mt-4 sm:mt-0">
              Reach out for collaboration, inquiries, or to discuss your next
              digital endeavor.
            </p>
            <div className="flex items-center gap-4 flex-wrap md:gap-8 mt-10">
              ...
              <span className="w-[35px] h[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://github.com/Yashu9084"
              ...
              <span className="w-[35px] h[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://instagram.com/yashumittal9084?igshid=NzZlODBkYWE4Ng=="
                  className=" text-gray-300 font-[500] text-[18px]"
                >
              ...
              <span className="w-[35px] h[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://twitter.com/yashu9084"
                  className=" text-gray-300 font-[500] text-[18px]"
                >
              ...
              <span className="w-[35px] h[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://www.linkedin.com/in/yashu-mittal-9448b5225/"
                  className=" text-gray-300 font-[500] text-[18px]"
                >
          ...
          <div className="flex items-center justify-center sm:justify-between">
            <div className="hidden sm:block">
              <div className="flex items-center gap-[10px]">
                ...
                <div className="leading-[20px]">
                  <h2 className="text-gray-200 font-[500px] text-[18px] ">
                    Yashu
                  </h2>
            ...
            <div>
              <p className="text-gray-400 text-[14px]">
                Copyright {year} developed by Yashu - ALl rights reserved.
              </p>
            </div>
          </div>
        </div>
